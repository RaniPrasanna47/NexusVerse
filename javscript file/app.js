...
change((heading.innerHTML = "Welcome"), 1000)
  ...
  .then(() => {
    return change((heading.innerHTML = "To"), 0);
  })
  .then(() => {
  ...
  .then(() => {
    return change((heading.innerHTML = "NexusVerse"), 1000);
  })
  .then(() => {
    return change(
  ...
  .then(() => {
    return change((heading.innerHTML = "By"), 1000);
  })
  .then(() => {
    return change(
  ...
  .then(() => {
    return change((heading.innerHTML = "RadioNitroz"), 1000);
  })
  .then(() => {
    return change(
